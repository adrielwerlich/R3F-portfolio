  ...
  return (
    <group position={[-1.56, 0.05, -2.38]} rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <RoundedSquare
        {...textSquareParams}
        width={0.2}
        position={[3.2, 0.65 - 0.125 * -0.5, 0]}
        color={"#000000"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.25}
        position={[3.45, 0.65 - 0.125 * -0.5, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.225}
        position={[3.75, 0.65 - 0.125 * -0.5, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.3}
        position={[3.2, 0.65 - 0.125 * 1.5, 0]}
        color={"#000000"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.6}
        position={[3.2, 0.65 - 0.125 * 3, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.1}
        position={[3.9, 0.65 - 0.125 * 3, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.3}
        position={[3.2, 0.65 - 0.125 * 5, 0]}
        color={"#000000"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.1}
        position={[3.9, 0.65 - 0.125 * 5, 0]}
        color={"#000000"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.43}
        position={[3.2, 0.65 - 0.125 * 7, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.35}
        position={[3.2, 0.65 - 0.125 * 8.5, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.29}
        position={[3.2, 0.65 - 0.125 * 10, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.42}
        position={[3.2, 0.65 - 0.125 * 11.5, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.4}
        position={[3.2, 0.65 - 0.125 * 13, 0]}
        color={"#cbcbcb"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.1}
        position={[3.2, 0.65 - 0.125 * 16, 0]}
        color={"#2885f6"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.1}
        position={[3.2, 0.65 - 0.125 * 17.5, 0]}
        color={"#7babe6"}
      />
      <RoundedSquare
        {...textSquareParams}
        width={0.1}
        position={[3.2, 0.65 - 0.125 * 19, 0]}
        color={"#142b61"}
      />
    </group>
  )
