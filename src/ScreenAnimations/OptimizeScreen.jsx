...
export default function OptimizeLaptopScreen() {
  ...
  return (
    <group position={[-1.56, 0.05, -2.38]} rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 0,
          BASELINE + COL_1_BLUE_HEIGHT + COL_1_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 1,
          BASELINE + COL_2_BLUE_HEIGHT + COL_2_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 2,
          BASELINE + COL_3_BLUE_HEIGHT + COL_3_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 3,
          BASELINE + COL_4_BLUE_HEIGHT + COL_4_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 4,
          BASELINE + COL_5_BLUE_HEIGHT + COL_5_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 5,
          BASELINE + COL_6_BLUE_HEIGHT + COL_6_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
      ...
      <RoundedSquare
        ...
        position={[
          GAP * 6,
          BASELINE + COL_7_BLUE_HEIGHT + COL_7_VIOLET_HEIGHT,
          0.04,
        ]}
      />
      {/* Violet */}
